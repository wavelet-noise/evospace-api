...
namespace detail {
  ...
  T *construct_at(T *ptr, Args &&...args) noexcept(
    ...
    return static_cast<T *>(::new (
      const_cast<void *>(static_cast<const void *>(ptr))) T(std::forward<Args>(args)...));
  }
...
public:
    ...
    template <class... Args>
    constexpr explicit expected_storage(
      std::in_place_t, Args &&...args) noexcept(std::is_nothrow_constructible_v<T, Args...>)
      : value_(std::forward<Args>(args)...) {}

    template <class... Args>
    constexpr explicit expected_storage(
      UnexpectType, Args &&...args) noexcept(std::is_nothrow_constructible_v<E, Args...>)
      : error_(std::forward<Args>(args)...) {}
...
protected:
    ...
    constexpr ExpectedBaseNonTrivial(
      std::in_place_t, Args &&...args) noexcept(std::
    ...
    template <class... Args>
    constexpr ExpectedBaseNonTrivial(
      UnexpectType, Args &&...args) noexcept(std::
                                               is_nothrow_constructible_v<
...
class Expected : public detail::ExpectedBase<
  ...
  constexpr explicit Expected(
    std::in_place_t, std::initializer_list<U> ilist, Args &&...args) noexcept(std::
                                                                                is_nothrow_constructible_v<
  ...
  template <class G = E>
  constexpr Expected(const Unexpected<G> &u) noexcept(std::
                                                        is_nothrow_constructible_v<
  ...
  template <class U, class... Args>
  constexpr explicit Expected(
    UnexpectType, std::initializer_list<U> ilist, Args &&...args) noexcept(std::
                                                                             is_nothrow_constructible_v<
  ...
  template <class... Args>
  T &emplace(Args &&...args) noexcept(noexcept(std::declval<this_type>()
  ...
  void swap(Expected &other) noexcept(detail::is_nothrow_swappable<value_type>::value
  ...
  auto assign(Tag tag, Args &&...args) noexcept(noexcept(
    std::declval<this_type>().destroy()) && noexcept(std::declval<this_type>()
