...
//=================================================================================================
/**
 * @brief Invokes undefined behavior when an unreachable part of the code is
 * reached.
 *
...
//=================================================================================================
/**
 * @brief Provides the member typedef type which is the type referred to by T
...
template <class...> struct function_traits_impl;
...
struct function_traits_impl<R (C::*)(Args...)>
    : function_traits_base<true, false, R, Args...> {};

template <class C, class R, class... Args>
struct function_traits_impl<R (C::*)(Args...) const>
    : function_traits_base<true, true, R, Args...> {};

template <class R, class... Args>
struct function_traits_impl<R(Args...) noexcept>
    : function_traits_base<false, false, R, Args...> {};
...
#if _MSC_VER && _M_IX86 // Windows: WINAPI (a.k.a. __stdcall) function pointers
                        // (32bit only).
template <class R, class... Args>
struct function_traits_impl<R __stdcall(Args...)>
    : function_traits_base<false, false, R, Args...> {};
...
template <class C, class R, class... Args>
struct function_traits_impl<R (__stdcall C::*)(Args...)>
    : function_traits_base<true, false, R, Args...> {};

template <class C, class R, class... Args>
struct function_traits_impl<R (__stdcall C::*)(Args...) const>
    : function_traits_base<true, true, R, Args...> {};

template <class R, class... Args>
struct function_traits_impl<R __stdcall(Args...) noexcept>
    : function_traits_base<false, false, R, Args...> {};
...
template <class C, class R, class... Args>
struct function_traits_impl<R (__stdcall C::*)(Args...) noexcept>
    : function_traits_base<true, false, R, Args...> {};

template <class C, class R, class... Args>
struct function_traits_impl<R (__stdcall C::*)(Args...) const noexcept>
    : function_traits_base<true, true, R, Args...> {};
#endif
 ...
 */
template <class F>
struct function_traits : std::conditional_t<
                             std::is_class_v<F>, detail::functor_traits_impl<F>,
                             detail::function_traits_impl<F>> {};

//=================================================================================================
/**
 * @brief Deduces the argument type of a callble object or void in case it has
 * no argument.
 *
...
template <std::size_t I, class F>
    struct function_argument_or_void < I,
    F,
    std::enable_if_t<
        I<std::tuple_size_v<typename function_traits<F>::argument_types>>> {
    using type =
        std::tuple_element_t<I, typename function_traits<F>::argument_types>;
};

template <std::size_t I, class F>
using function_argument_or_void_t =
    typename function_argument_or_void<I, F>::type;
...
/**
 * @brief An integral constant expression that gives the number of arguments
 * accepted by the callable object.
 *
 * @tparam F Callable object.
 */
template <class F>
...
/**
 * @brief An boolean constant expression that checks if the callable object is a
 * member function.
 *
 * @tparam F Callable object.
 */
...
/**
 * @brief An boolean constant expression that checks if the callable object is
 * const.
 *
 * @tparam F Callable object.
 */
 ...
 */
template <class T, class = void> struct is_callable {
 ...
 */
template <class T> struct is_const_member_function_pointer {
    static constexpr bool value = false;
};
...
template <class T>
inline static constexpr bool is_const_member_function_pointer_v =
    is_const_member_function_pointer<T>::value;
 ...
 */
template <class T> struct is_cfunction_pointer {
    static constexpr bool value = false;
};

template <> struct is_cfunction_pointer<int (*)(lua_State *)> {
    static constexpr bool value = true;
};

template <class T>
inline static constexpr bool is_cfunction_pointer_v =
 ...
 */
template <class T> struct is_member_cfunction_pointer {
    static constexpr bool value = false;
};

template <class T> struct is_member_cfunction_pointer<int (T::*)(lua_State *)> {
    static constexpr bool value = true;
};
...
template <class T>
inline static constexpr bool is_member_cfunction_pointer_v =
    is_member_cfunction_pointer<T>::value;
 ...
 */
template <class T> struct is_const_member_cfunction_pointer {
    static constexpr bool value = false;
};
...
template <class T>
inline static constexpr bool is_const_member_cfunction_pointer_v =
    is_const_member_cfunction_pointer<T>::value;
 ...
 */
template <class T>
inline static constexpr bool is_any_cfunction_pointer_v =
    is_cfunction_pointer_v<T> || is_member_cfunction_pointer_v<T>;
...
inline static constexpr bool is_proxy_member_function_v =
    ...
    std::is_same_v<
        T, remove_cvref_t<
               std::remove_pointer_t<function_argument_or_void_t<0, F>>>>;
...
/**
 * @brief An integral constant expression that gives the number of arguments
 * excluding one type (usually used with lua_State*) accepted by the callable
 * object.
 *
 * @tparam F Callable object.
 */
template <class, class> struct function_arity_excluding {};

template <class... Ts, class ExclusionType>
struct function_arity_excluding<std::tuple<Ts...>, ExclusionType>
    : std::integral_constant<
          std::size_t,
          (0 + ... + (std::is_same_v<std::decay_t<Ts>, ExclusionType> ? 0 : 1)
          )> {};

template <class F, class ExclusionType>
inline static constexpr std::size_t function_arity_excluding_v =
    function_arity_excluding<function_arguments_t<F>, ExclusionType>::value;
...
struct member_function_arity_excluding<
    T, F, std::tuple<Ts...>, ExclusionType,
    std::enable_if_t<!is_proxy_member_function_v<T, F>>>
    : std::integral_constant<
          std::size_t,
          (0 + ... + (std::is_same_v<std::decay_t<Ts>, ExclusionType> ? 0 : 1)
          )> {};
...
inline static constexpr std::size_t member_function_arity_excluding_v =
    member_function_arity_excluding<
        T, F, function_arguments_t<F>, ExclusionType>::value;

//=================================================================================================
/**
 * @brief Detectors for const and non const functions in packs and counting
 * them.
 */
template <class T, class F>
static constexpr bool is_const_function =
    detail::is_const_member_function_pointer_v<F> ||
    (detail::function_arity_v<F> > 0 &&
     detail::is_const_proxy_function_v<T, F>);

template <class T, class... Fs>
inline static constexpr std::size_t const_functions_count =
    (0 + ... + (is_const_function<T, Fs> ? 1 : 0));

template <class T, class... Fs>
inline static constexpr std::size_t non_const_functions_count =
    (0 + ... + (is_const_function<T, Fs> ? 0 : 1));
 ...
 */
template <class... Types> constexpr auto tupleize(Types &&...types) {
 ...
 */
template <class T> struct remove_first_type {};

template <class T, class... Ts> struct remove_first_type<std::tuple<T, Ts...>> {
